...
export type DestinationTheme = 'city' | 'culture' | 'food' | 'beach' | 'nature' | 'adventure';
...
export const destinations: Destination[] = [
  {
    ...
    region: 'Евразия', tags: ['Город', 'Культура', 'Гастрономия'], themeIds: ['city', 'culture', 'food'],
  ...
  },
  {
    ...
    region: 'Юго-Восточная Азия', tags: ['Пляж', 'Природа', 'Приключения'], themeIds: ['beach', 'nature', 'adventure'],
  ...
  },
  {
    ...
    region: 'Восточная Азия', tags: ['Город', 'Культура', 'Гастрономия'], themeIds: ['city', 'culture', 'food'],
  ...
  },
  {
    ...
    region: 'Юго-Восточная Азия', tags: ['Город', 'Природа', 'Гастрономия'], themeIds: ['city', 'nature', 'food'],
  ...
  },
  {
    ...
    region: 'Кавказ', tags: ['Город', 'Культура', 'Гастрономия', 'Природа'], themeIds: ['city', 'culture', 'food', 'nature'],
  ...
  },
  {
    ...
    region: 'Восточная Азия', tags: ['Город', 'Природа', 'Приключения', 'Гастрономия'], themeIds: ['city', 'nature', 'adventure', 'food'],
  ...
  },
  {
    ...
    region: 'Европа', tags: ['Город', 'Культура', 'Гастрономия'], themeIds: ['city', 'culture', 'food'],
  ...
  },
  {
    ...
    region: 'Юго-Восточная Азия', tags: ['Пляж', 'Город', 'Природа'], themeIds: ['beach', 'city', 'nature'],
